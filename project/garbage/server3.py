...
class Server:
    ...
    async def handle_input(self, reader, writer):
        ...
        sendback_message = ""
        if ((len(message_array) == 4 and (message_array[0] == "IAMAT" or message_array[0] == "WHATSAT")) or (
                len(message_array) == 6 and message_array[0] == "AT")):
    ...
    async def AT_func(self, message_array):
        ...
        message_str = "{} {} {} {} {} {}".format(message_array[0], message_array[1], message_array[2], message_array[3],
                                                 message_array[4], message_array[5])
...
def main():
    ...
    logging.basicConfig(filename=args.server_name + "-log", format='%(name)s - %(levelname)s - %(message)s',
